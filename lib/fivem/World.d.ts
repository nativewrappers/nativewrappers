...
import { CameraTypes, CloudHat, IntersectFlags, type MarkerType, type PickupType, type RopeType, Weather } from "./enums";
import { Ped, Vehicle } from "./models";
import type { BaseEntity } from "./models/BaseEntity";
import { Pickup } from "./Pickup";
import { AsynchronousRaycastResult, SynchronousRaycastResult } from "./Raycast";
import { Rope } from "./Rope";
import { type Color, Vector3 } from "./utils";
/**
...
export declare abstract class World {
     ...
     */
    static createCameraWithParams(cameraType: CameraTypes | undefined, position: Vector3, rotation: Vector3, fieldOfView: number): Camera;
    /**
