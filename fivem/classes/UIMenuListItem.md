...
| <a id="listselected"></a> `listSelected` | `readonly` | [`LiteEvent`](LiteEvent.md) | - | - | fivem/ui/menu/items/UIMenuListItem.d.ts:6 |
...
Defined in: fivem/ui/menu/items/UIMenuListItem.d.ts:25
