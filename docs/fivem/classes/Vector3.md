...
Defined in: lib/common/utils/Vector.d.ts:336
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="size"></a> `[size]` | `readonly` | `number` | `undefined` | `Vector.[size]` | - | lib/common/utils/Vector.d.ts:338 |
| <a id="type"></a> `type` | `readonly` | `Vector3` | `ClassTypes.Vector3` | `Vector.type` | - | lib/common/utils/Vector.d.ts:337 |
| <a id="w"></a> `w` | `public` | `undefined` \| `number` | `undefined` | - | `Vector.w` | lib/common/utils/Vector.d.ts:218 |
| <a id="x-1"></a> `x` | `public` | `number` | `undefined` | - | `Vec3.x` `Vector.x` | lib/common/utils/Vector.d.ts:215 |
| <a id="y-1"></a> `y` | `public` | `number` | `undefined` | - | `Vec3.y` `Vector.y` | lib/common/utils/Vector.d.ts:216 |
| <a id="z-1"></a> `z` | `public` | `number` | `undefined` | `Vec3.z` `Vector.z` | - | lib/common/utils/Vector.d.ts:339 |
| <a id="backward"></a> `Backward` | `readonly` | [`Vector3`](Vector3.md) | `undefined` | - | - | lib/common/utils/Vector.d.ts:353 |
| <a id="backwardlh"></a> `BackwardLH` | `readonly` | [`Vector3`](Vector3.md) | `undefined` | - | - | lib/common/utils/Vector.d.ts:352 |
| <a id="backwardrh"></a> `BackwardRH` | `readonly` | [`Vector3`](Vector3.md) | `undefined` | - | - | lib/common/utils/Vector.d.ts:351 |
| <a id="down"></a> `Down` | `readonly` | [`Vector3`](Vector3.md) | `undefined` | - | - | lib/common/utils/Vector.d.ts:346 |
| <a id="forwardlh"></a> `ForwardLH` | `readonly` | [`Vector3`](Vector3.md) | `undefined` | - | - | lib/common/utils/Vector.d.ts:350 |
| <a id="forwardrh"></a> `ForwardRH` | `readonly` | [`Vector3`](Vector3.md) | `undefined` | - | - | lib/common/utils/Vector.d.ts:349 |
| <a id="left"></a> `Left` | `readonly` | [`Vector3`](Vector3.md) | `undefined` | - | - | lib/common/utils/Vector.d.ts:347 |
| <a id="one"></a> `One` | `readonly` | [`Vector3`](Vector3.md) | `undefined` | - | - | lib/common/utils/Vector.d.ts:344 |
| <a id="right"></a> `Right` | `readonly` | [`Vector3`](Vector3.md) | `undefined` | - | - | lib/common/utils/Vector.d.ts:348 |
| <a id="unitx"></a> `UnitX` | `readonly` | [`Vector3`](Vector3.md) | `undefined` | - | - | lib/common/utils/Vector.d.ts:341 |
| <a id="unity"></a> `UnitY` | `readonly` | [`Vector3`](Vector3.md) | `undefined` | - | - | lib/common/utils/Vector.d.ts:342 |
| <a id="unitz"></a> `UnitZ` | `readonly` | [`Vector3`](Vector3.md) | `undefined` | - | - | lib/common/utils/Vector.d.ts:343 |
| <a id="up"></a> `Up` | `readonly` | [`Vector3`](Vector3.md) | `undefined` | - | - | lib/common/utils/Vector.d.ts:345 |
| <a id="zero"></a> `Zero` | `readonly` | [`Vector3`](Vector3.md) | `undefined` | - | - | lib/common/utils/Vector.d.ts:340 |
