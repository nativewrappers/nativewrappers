...
Defined in: [src/common/utils/Vector.ts:696](https://github.com/nativewrappers/nativewrappers/blob/0bf5a50fdb39736240229f922b5089be4fd3a85c/src/common/utils/Vector.ts#L696)
...
Defined in: [src/common/utils/Vector.ts:709](https://github.com/nativewrappers/nativewrappers/blob/0bf5a50fdb39736240229f922b5089be4fd3a85c/src/common/utils/Vector.ts#L709)
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="size"></a> `[size]` | `readonly` | `number` | `2` | `Vector.[size]` | - | [src/common/utils/Vector.ts:700](https://github.com/nativewrappers/nativewrappers/blob/0bf5a50fdb39736240229f922b5089be4fd3a85c/src/common/utils/Vector.ts#L700) |
| <a id="type"></a> `type` | `readonly` | `Vector2` | `ClassTypes.Vector2` | `Vector.type` | - | [src/common/utils/Vector.ts:699](https://github.com/nativewrappers/nativewrappers/blob/0bf5a50fdb39736240229f922b5089be4fd3a85c/src/common/utils/Vector.ts#L699) |
...
| <a id="z"></a> `z` | `public` | `undefined` \| `number` | `undefined` | - | `Vector.z` | [src/common/utils/Vector.ts:510](https://github.com/nativewrappers/nativewrappers/blob/0bf5a50fdb39736240229f922b5089be4fd3a85c/src/common/utils/Vector.ts#L510) |
| <a id="zero"></a> `Zero` | `readonly` | [`Vector2`](Vector2.md) | `undefined` | - | - | [src/common/utils/Vector.ts:702](https://github.com/nativewrappers/nativewrappers/blob/0bf5a50fdb39736240229f922b5089be4fd3a85c/src/common/utils/Vector.ts#L702) |
...
Defined in: [src/common/utils/Vector.ts:719](https://github.com/nativewrappers/nativewrappers/blob/0bf5a50fdb39736240229f922b5089be4fd3a85c/src/common/utils/Vector.ts#L719)
